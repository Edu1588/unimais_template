        ...
        <div className="bg-primary rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
            <button 
              ...
              className="bg-whatsapp-green text-white px-8 py-4 rounded-xl font-label-lg text-label-lg hover:bg-green-600 transition-colors shadow-lg flex items-center justify-center gap-2"
            >
