...
export default function Testimonials() {
  const reviews = [
    ...
    {
      name: "Roberto Alves",
      text: "Fui na loja de Hortolândia e me surpreendi. Eles cuidaram de toda a papelada e não precisei me preocupar com nada. Empresa séria e com muita credibilidade na região de Campinas.",
    }
  ];
      ...
      <div className="max-w-max-width mx-margin-desktop px-gutter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((review, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-outline-variant flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center shrink-0 border border-outline-variant">
                ...
                <div className="flex flex-col">
                  <a href="#" className="font-bold text-blue-600 text-sm hover:underline">{review.name}</a>
